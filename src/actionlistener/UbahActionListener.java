...
public class UbahActionListener implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (row == -1 || column == -1) {
            this.biodataFrame.showAlertFailed("belum dipilih!");
            return;
        }
        ...
        // Instansiasi objek SimpanUbahActionListener dengan nama simpanPerubahanListener
        SimpanPerubahanActionListener simpanPerubahanListener = new SimpanPerubahanActionListener(
                this.biodataFrame,
                this.biodataDao,
                id);

        // Tambahkan action listener pada buttonSimpanPerubahan
        this.biodataFrame.getButtonSimpanPerubahan().addActionListener(simpanPerubahanListener);
    }
}
