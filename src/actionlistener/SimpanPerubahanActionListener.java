 ...
 */
public class SimpanPerubahanActionListener implements ActionListener{
    ...
    public SimpanPerubahanActionListener(BiodataFrame biodataFrame, BiodataDao biodataDao, String id) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // Jika confirmation nilai opsi no
            ...
            this.biodataFrame.showAlertFailed("tidak diubah");
        }
        ...
        this.biodataFrame.getButtonSimpanPerubahan().removeActionListener(this);
    }
}
